...
python rcsb_api_downloader.py --start 2024-01-01 --end 2024-06-30

2. Just get the ID list first, without downloading files (fast check)
python rcsb_api_downloader.py --start 2024-01-01 --end 2024-06-30 --ids-only

3. Download as .cif format instead of .pdb
python rcsb_api_downloader.py --start 2024-01-01 --end 2024-06-30 --format cif
